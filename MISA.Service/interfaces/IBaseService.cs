...
namespace MISA.Service.interfaces
{
    public interface IBaseService<T>
    {
        ...
        /// <returns></returns>
        /// Created by PN Thuận : 6/2/2021
        ServiceResult InsertEntity<T>(T entity);
        /// <summary>
        ...
        /// <returns></returns>
        /// Created by PN Thuận : 6/2/2021
        ServiceResult DeleteEntityById<T>(string id);
        /// <summary>
        ...
        /// <returns></returns>
        /// Created by PN Thuận : 6/2/2021
        ServiceResult ModifiedEntity<T>(T entity, string Id);
    }
}
