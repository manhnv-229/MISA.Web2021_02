...
{
    // Database của Vũ Minh Hiếu
    public class DbConnection<T> : IBaseData<T>
    {

        private string ConnectionString = "User Id = nvmanh; password=12345678;Database=MS1_44_VUMINHHIEU_CukCuk;Host=103.124.92.43;port=3306;Character Set = utf8";
