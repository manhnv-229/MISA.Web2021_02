...
{
    //BaseBussiness_2<Employee>: chỉ định lớp cha nếu như không dùng kỹ thuật DI
    public class EmployeeBussiness_V2 : BaseBussiness_V2<Employee>, IEmployeeBussiness
    {
        private IEmployeeData _employeeData;
        private IBaseBussiness<Employee> _baseBussiness;


        public EmployeeBussiness_V2(IEmployeeData employeeData, IBaseBussiness<Employee> baseBussiness, IBaseData<Employee> baseData) : base(baseData)
        {
