...
namespace MISA.DataLayer
{
    ...
    public class DbContextV2<T> : IBaseDBConnection<T>
    {
        #region DECLARE
        // khai báo đường dẫn database
        protected string _connectionString = "User Id=nvmanh;Host=103.124.92.43; Port = 3306;Character Set=utf8; Database = MS4_16_VuThanhThien_CukCuk ; Password = 12345678";
