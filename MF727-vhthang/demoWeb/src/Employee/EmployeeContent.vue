                    ...
                    <div class="content-left">
                        ...
                        <div class="grid-content">
                            ...
                            <div class="grid-item">
                                ...
                                :options="['Mã nhân viên', 'Họ và tên', 'Lương', 'Ngày sinh']"
                                :default="'Sắp xếp'"
                                class="select"
                                @input="input"
                                />
                    ...
                    <table id="tb-customer" cellspacing="0" cellpadding="0" border="0" class="table1" >
                        ...
                        <tbody class="tb1">
                            ...
                            <td>
                                ...
                                <td>
                                <div class="cell">{{ formatEmpty(employee.employeePlaceRegistration) }}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                <div class="cell">{{ formatEmpty(employee.employeePosition) }}</div>
                                </td>
                                <td>
                                <div class="cell">{{ formatEmpty(employee.employeeDepartment) }}</div>
                                </td>
                                <td>
                                <div class="cell">{{ formatEmpty(employee.employeeTaxNumber) }}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                <div class="cell">{{ formatEmpty(employee.employeeStatus) }}</div>
                                </td>
                            </tr>
...
import EmployeeSelectCustom from './EmployeeSelectCustom.vue';
export default {
    ...
    methods:{
        ...
        showEmployee(data){
            ...
            this.$emit('showEmployee',data,$event);
        },
        formatGender(value){
            if(value == 1){
                return "Nam";
