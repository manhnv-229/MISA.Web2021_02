...
namespace MISA.BTL.Database
{
    ...
    {
        #region Declare
        protected string _connectionString = "User Id=nvmanh; Host=103.124.92.43; Database=MS1_35_TKTHIEN_CukCuk; port=3306; password=12345678; Character Set=utf8;";
        ...
        public virtual IEnumerable<T> GetData()
        {
            ...
            var storeName = $"Proc_GetCustomerGroups";
